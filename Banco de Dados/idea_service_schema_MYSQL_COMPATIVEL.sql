...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS niveis_acesso (
...
-- Tabela de endereços
CREATE TABLE IF NOT EXISTS IF NOT EXISTS enderecos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS categorias_servicos (
...
-- Tabela de serviços
CREATE TABLE IF NOT EXISTS IF NOT EXISTS servicos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS pacotes (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS pacotes_servicos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS status_orcamentos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS orcamentos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS itens_orcamento (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS status_agendamentos (
    id_status INT AUTO_INCREMENT PRIMARY KEY,
    nome VARCHAR(50) NOT NULL,
    ``descricao`` TEXT,
    cor VARCHAR(7) DEFAULT '#000000',
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS agendamentos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS tecnicos_agendamento (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS status_atendimentos (
    id_status INT AUTO_INCREMENT PRIMARY KEY,
    nome VARCHAR(50) NOT NULL,
    ``descricao`` TEXT,
    cor VARCHAR(7) DEFAULT '#000000',
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS atendimentos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS depoimentos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS conteudo_site (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS contatos (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS logs_sistema (
